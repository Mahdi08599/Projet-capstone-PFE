...
\begin{tikzpicture}[remember picture, overlay]
    ...
    % Logo PST&B : uploader figures/pstb_logo.png dans Overleaf
    \node[anchor=north west] at ([xshift=1.85cm,yshift=-1.25cm]current page.north west) {
        \IfFileExists{figures/pstb_logo.png}{
            \includegraphics[height=1.45cm]{figures/pstb_logo.png}
        }{
...
Precision & Part des alertes du modele qui correspondent r̩ellement a des fraudes. \\
